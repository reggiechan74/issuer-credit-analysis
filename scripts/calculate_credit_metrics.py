...
# Import burn rate functions from dedicated module
from calculate_credit_metrics.burn_rate import (
    calculate_burn_rate,
...
# Burn rate functions (calculate_burn_rate, calculate_cash_runway, assess_liquidity_risk,
# calculate_sustainable_burn_rate) are imported from calculate_credit_metrics.burn_rate module
# See lines 26-31 for imports
